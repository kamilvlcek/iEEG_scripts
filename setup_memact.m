...
if alignresponse % align epochs to the response 
    ...
    setup.epochtime =  [-0.5 2.0 0];  % hranice epochy: [-0.3 0.8] PPA, zarovnani podle odpovedi/podnetu [-1 1]; [-0.2 1.2] AEdist [-0.2 2.0] pro ResampleEpochs
    setup.baseline = [-.5 -0.1]  ; %baseline [-1 0.8]; [-0.5 -0.2] Aedist 2017. 2017/11 - zase [-.2 0]    
end
setup.prefix = 'MemAct'; %musi byt bud AlloEgo, PPA, AEdist
...
setup.subfolder = 'memact'; %podadresar, specificky pro test, muze byt prazdne pokud se nepouzivaji podadresare
