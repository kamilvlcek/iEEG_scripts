...
% pacienti(p).psychopy = 'p73_menrot.mat';
% pacienti(p).rjepoch = 'p073_menrot_RjEpoch.mat'; %2017 
...
% pacienti(p).psychopy = 'p79_menrot.mat';
% pacienti(p).rjepoch = 'p079_menrot_RjEpoch.mat'; %'menrot RjEpoch Resp.mat';
...
% pacienti(p).psychopy = 'p82_menrot.mat';
% pacienti(p).rjepoch = 'p082_menrot_RjEpoch.mat';
...
% pacienti(p).psychopy = 'p83_menrot.mat';
% pacienti(p).rjepoch = 'p083_menrot_RjEpoch.mat';
...
% pacienti(p).header = 'p130_header.mat';
% pacienti(p).psychopy = 'p130_menrot.mat';
% pacienti(p).rjepoch = 'p130_menrot_RjEpoch.mat';
% pacienti(p).epievents = 'p130_menrot_epievents.mat'; %2017 
% pacienti(p).rjch = [47]; 
