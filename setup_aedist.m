...
if alignresponse %zarovnani epoch podle odpovedi
    ...
    setup.epochtime =  [-0.5 1.5 0];  % hranice epochy: [-0.3 0.8] PPA, zarovnani podle odpovedi/podnetu [-1 1]; [-0.2 1.2] AEdist [-0.2 2.0] pro ResampleEpochs
...
setup.stat_kats = {[0 1 2],[2 1 0]};  % AEdist [0 1 2] Control, Ego, Allo; 
